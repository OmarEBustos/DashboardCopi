                        ...
                        <div class="header mt-md-5">
                            <div class="header-body">
                                ...
                                <div class="col">
                                    ...
                                    <li class="nav-item">
                                        <router-link to="/producto" class="nav-link">All the Products</router-link>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="file" id="input_file" class="form-control" placeholder="Select an image" v-on:change="uploadImage($event)">
                                            ...
                                            <small class="form-text text-muted">
                                                Upload a maximum of 5 images, including the main cover.
                                            </small>
                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="row">
                                                    <div class="col text-center">
                                                        <a v-b-modal="'delete-'+item._id" style="cursor:pointer" class="text-danger">Delete image</a>
            ...
            if(image.size <= 1000000){
               if(image.type == 'image/jpeg'||image.type == 'image/png'||image.type == 'image/webp'||image.type == 'image/jpg'){
                   ...
                   this.$notify({
                        group: 'foo',
                        title: 'ERROR',
                        text: 'The resource must be image',
                        type: 'error'
                    });
                ...
                this.$notify({
                    group: 'foo',
                    title: 'ERROR',
                    text: 'The image must be less than 1MB',
                    type: 'error'
                });
                this.imagen = undefined;
                 $('#input_file').val('');
