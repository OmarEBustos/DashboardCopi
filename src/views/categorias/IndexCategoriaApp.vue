            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 col-xl-8">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <button v-if="!section_form" class="btn btn-dark btn-sm" v-on:click="section_form = true;">New category</button>
                                <button v-if="section_form" class="btn btn-dark btn-sm" v-on:click="section_form = false;">Disguise</button>
                            </div>
                            <div class="col-12 mt-3" v-if="section_form">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="New category" v-model="nueva_categoria">
                                    <button class="btn btn-dark" v-on:click="crear_categoria()">Create category</button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li class="list-group-item" v-for="item in categorias">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ms-n2">
                                                ...
                                                <p class="small mb-0" v-if="!item.categoria.estado">
                                                    <span class="text-danger">●</span> Hidden
                                                </p>
                                        ...
                                        <div class="input-group mt-4 hide_input content_group" :id="'content_'+item.categoria._id">
                                            <input type="text" class="form-control" placeholder="New Subcategory" v-model="nueva_subcategoria">
                                            <button class="btn btn-dark" v-on:click="crear_subcategoria()">Create subcategory</button>
                                        </div>
            ...
            axios.post(this.$url+'/crear_categoria_admin',{titulo: this.nueva_categoria},{
                ...
                if(result.data.message){
                    ...
                    this.$notify({
                        group: 'foo',
                        title: 'SUCCESS',
                        text: 'The Category was registered.',
                        type: 'success'
                    });
                }
            ...
            ,{
                ...
                if(result.data.message){
                    ...
                    this.$notify({
                        group: 'foo',
                        title: 'SUCCESS',
                        text: 'The Subcategory was registered.',
                        type: 'success'
                    });
                    this.init_data();
                }
    ...
    cambiar_estado(id,estado){
        axios.put(this.$url+'/cambiar_estado_producto_admin/'+id,{estado: estado},{
            ...
            this.$notify({
                group: 'foo',
                title: 'SUCCESS',
                text: 'Subcategory status changed',
                type: 'success'
            });
