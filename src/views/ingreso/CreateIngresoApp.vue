                    ...
                    <div class="col-12 col-lg-10 col-xl-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                             ...
                             Last name v-model="ingreso.ncomprobante" 
                            <div class="form-group">
                            ...
                            </div> v-model="ingreso.monto_total"-->
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">
                                    Subir imagen default.jpg.
                                </small>
                                
                                    <input type="file" class="form-control" v-on:change="uploadComprobante($event)" >

                            </div> <!--type="file" class="form-control" v-on:change="uploadComprobante($event)"-->
                            ...
                            <!-- First name @select="producto_selected"-->
                            <div class="form-group">
  ...
  methods: {
      uploadComprobante($event){
            ...
            if(image.size <= 1000000){
               ...
               ||image.type == 'image/jpg'|| image.type === 'application/pdf'){
      ...
      registro_ingreso(){
           /* if(!this.ingreso.proveedor){
                ...
                this.$notify({
                    group: 'foo',
                    title: 'ERROR',
                    text: 'Suba la imagen default.jpg',
                    type: 'error'
                });
            }else {
